 ...
 * @author trev
 */
public class SizableConcurrentHashMapAdapter<K extends Comparable<? super K>> extends AbstractAdapter<K> implements SetInterface<K> {
    public SizableConcurrentHashMap<K,K> tree;

    public SizableConcurrentHashMapAdapter() {
        tree = new SizableConcurrentHashMap<>();
    }
