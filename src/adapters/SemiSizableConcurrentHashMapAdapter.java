...
import adapters.semi_sizable_wrappers.SemiSizableConcurrentHashMap;
import adapters.sizable_warppers.SizableConcurrentHashMap;
 ...
 * @author trev
 */
public class SemiSizableConcurrentHashMapAdapter<K extends Comparable<? super K>> extends AbstractAdapter<K> implements SetInterface<K> {
    public SemiSizableConcurrentHashMap<K,K> tree;

    public SemiSizableConcurrentHashMapAdapter() {
        tree = new SemiSizableConcurrentHashMap<>();
    }
