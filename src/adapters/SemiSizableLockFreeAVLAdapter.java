...
import adapters.semi_sizable_wrappers.SemiSizableLockFreeRelaxedAVLMap;
 ...
 * @author trev
 */
public class SemiSizableLockFreeAVLAdapter<K extends Comparable<? super K>> extends AbstractAdapter<K> implements SetInterface<K> {
    public SemiSizableLockFreeRelaxedAVLMap<K,K> tree;

    public SemiSizableLockFreeAVLAdapter() {
        tree = new SemiSizableLockFreeRelaxedAVLMap<>();
    }
