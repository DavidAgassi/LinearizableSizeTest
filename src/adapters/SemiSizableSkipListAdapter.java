...
import adapters.semi_sizable_wrappers.SemiSizableSkipList;
 ...
 * @author trev
 */
public class SemiSizableSkipListAdapter<K extends Comparable<? super K>> extends AbstractAdapter<K> implements SetInterface<K> {
    public SemiSizableSkipList<K,K> tree;

    public SemiSizableSkipListAdapter() {
        tree = new SemiSizableSkipList<>();
    }
