 ...
 * @author trev
 */
public class SizableLockFreeAVLAdapter<K extends Comparable<? super K>> extends AbstractAdapter<K> implements SetInterface<K> {
    public SizableLockFreeRelaxedAVLMap<K,K> tree;

    public SizableLockFreeAVLAdapter() {
        tree = new SizableLockFreeRelaxedAVLMap<>();
    }
